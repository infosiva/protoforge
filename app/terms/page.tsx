...
export default function TermsPage() {
  return (
    <main style={{ maxWidth: 680, margin: '0 auto', padding: '60px 24px 80px', fontFamily: 'inherit', color: '#0f0f11' }}>
      <Link href="/" style={{ fontSize: 13, color: '#7c3aed', textDecoration: 'none', display: 'inline-block', marginBottom: 32 }}>
        ← Back to ProtoForge
      </Link>
      <h1 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: 8, letterSpacing: '-0.02em' }}>Terms of Use</h1>
      <p style={{ fontSize: 13, color: 'rgba(15,15,17,0.45)', marginBottom: 32 }}>Last updated: June 2026</p>

      <p style={{ fontSize: 14, lineHeight: 1.75, color: 'rgba(15,15,17,0.7)', marginBottom: 16 }}>
      ...
      <p style={{ fontSize: 13, color: 'rgba(15,15,17,0.45)', marginTop: 48 }}>
        Questions? Contact us at <a href="mailto:hello@protofast.app" style={{ color: '#7c3aed' }}>hello@protofast.app</a>
      </p>
    </main>
  )
}
